...
$TCA['tx_abbooking_product'] = array (
	...
	'columns' => array (
		...
		'capacitymin' => array (		## WOP:[tables][2][fields][2][fieldname]
			'displayCond' => 'FIELD:offtime_dummy:=:0',
			'l10n_mode' => 'exclude',
...
$TCA['tx_abbooking_price'] = array (
	...
	'columns' => array (
		...
		'adult1' => array (		## WOP:[tables][3][fields][1][fieldname]
			...
			'config' => array (
				...
				'size' => '40',	## WOP:[tables][3][fields][1][conf_size]
		...
		'discount' => array (		## WOP:[tables][3][fields][6][fieldname]
			...
			'config' => array (
				...
				'max' => '10',	## WOP:[tables][3][fields][6][conf_max]
		...
		'daySteps' => array (		## WOP:[tables][3][fields][1][fieldname]
			'l10n_mode' => 'exclude',
			'exclude' => 0,		## WOP:[tables][3][fields][1][excludeField]
			'label' => 'LLL:EXT:ab_booking/locallang_db.xml:tx_abbooking_price.daySteps',		## WOP:[tables][3][fields][1][title]
			'config' => array (
				'type' => 'input',	## WOP:[tables][3][fields][1][type]
				'size' => '10',	## WOP:[tables][3][fields][1][conf_size]
				'max' => '31',	## WOP:[tables][3][fields][1][conf_max]
	...
	'types' => array (
		'0' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, title, hidden;;1;;1-1-1, currency, adult1, adult2, adult3, adult4, adultX, extraComponent1, extraComponent2, discount, discountPeriod, singleComponent1, singleComponent2, minimumStay, blockDaysAfterBooking, daySteps, checkInWeekdays, seasonid')
	),
);
$TCA['tx_abbooking_seasons'] = array (
    ...
    'columns' => array (
		...
		'validWeekdays' => array (
			'l10n_mode' => 'exclude',
			'exclude' => 0,
			'label' => 'LLL:EXT:ab_booking/locallang_db.xml:tx_abbooking_seasons.validInWeekdays',
			'config' => array (
				'type' => 'input',
				'size' => '10',
				'default' => '*',
