...
CREATE TABLE tx_abbooking_price (
	...
	title tinytext,
	currency tinytext,
	adult1 double(11,2) DEFAULT '0.00' NOT NULL,
	adult2 double(11,2) DEFAULT '0.00' NOT NULL,
	adult3 double(11,2) DEFAULT '0.00' NOT NULL,
	adult4 double(11,2) DEFAULT '0.00' NOT NULL,
	child double(11,2) DEFAULT '0.00' NOT NULL,
	teen double(11,2) DEFAULT '0.00' NOT NULL,
